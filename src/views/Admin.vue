  ...
  data: () => ({
    ...
    vohContentTemp: {
      ...
      whyWeSing: {
        ...
        benefitsContent: '<p>No matter who you are or what kind of singing you do, the benefits to your physical, and mental/emotional\n' +
        ...
        incarcerationContent: '<p>Studies of prison choirs are limited due to the research protections of incarcerated people as a “vulnerable\n' +
      ...
      joinOurSong: {
        ...
        learAdvocateContent: '<h3 class="mb-2">More Information:</h3>\n' +
            '        <ul>\n' +
            '          <li>\n' +
