  ...
  <div class="page-container">
    ...
    <v-row class="ma-7">
      <v-col cols="12" sm="12" md="6" lg="2">
        <v-img class="ml-auto mr-auto" max-width="150px" src="../static/voh_logo.png"></v-img>
      </v-col>
      <v-col cols="12" sm="12" md="6" lg="10">
        <h2 class="mb-3">VOICES OF HOPE MISSION</h2>
    ...
    <v-row class="ma-7">
      <v-col>
        <h2 class="mb-3">HOPES</h2>
        <p>We recognize that Voices of Hope has a dual calling to serve communities both inside and outside of
    ...
    <v-row class="ma-7">
      <v-col>
        ...
        <p><b>Voices of Hope</b> began as the vision of Dr. Jim Verhoye, former Education Director at the Minnesota
    ...
    <v-row class="ma-7">
      <v-col cols="12" sm="12" md="6" lg="6">
        <h2 class="mb-3">CHOIRS</h2>
        <h3 class="font-italic mt-3">Voices of Hope-Shakopee</h3>
        <ul>
    ...
    <v-row class="ma-7 mb-0">
      <v-col>
        <h2 class="mb-3">STAFF</h2>
        <v-row>
          <v-col lg="4" md="4" sm="12" cols="12">
            <v-card elevation="3">
              <v-img class="staff-headshot" src="../static/amanda_headshot.jpg"></v-img>
              <v-card-title>Dr. Amanda Weber</v-card-title>
              <v-card-subtitle>Founder and Artistic Director</v-card-subtitle>
    ...
    <v-row class="ma-7 mb-14">
      ...
      <v-col lg="4" md="4" sm="12" cols="12">
        <h2 class="mb-3">VOLUNTEER TEAM</h2>
        <ul>
          <li>Laura Potratz</li>
