      ...
      <v-app-bar
        ...
        <v-row no-gutters>
          ...
          <v-col cols="7">
            ...
            <v-row>
              <v-btn class="ma-2 ml-auto white" depressed @click="Navigate('Home')">
                Home
              </v-btn>
              <v-btn class="ma-2 white" depressed @click="Navigate('WhoWeAre')">
                Who We Are
              </v-btn>
              <v-btn class="ma-2 white" depressed @click="Navigate('WhyWeSing')">
                Why We Sing
              </v-btn>

              <v-menu offset-y>
                <template v-slot:activator="{ on, attrs }">
                  <v-btn v-bind="attrs" v-on="on" class="ma-2 mr-0 white" depressed>
                    Join Our Song
